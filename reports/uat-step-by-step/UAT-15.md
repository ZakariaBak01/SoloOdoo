...
2. Click **Monthly Revenue** and compare with posted customer invoices minus credit notes for that month. Click **Unpaid Over 30 Days** and compare residuals with posted invoices in **Customers -> Invoices**, filtered by due date and payment status. If the optional Enterprise `account_reports` module is installed, U8 can instead provide **Reporting -> Aged Receivable** without granting U13 accounting administrator rights.
